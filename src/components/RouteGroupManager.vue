  ...
  <div class="bg-white p-4 rounded shadow">
    ...
    <div v-if="creatingGroup" class="space-y-2">
      ...
      <div class="space-y-1">
        <div>
          位置設定
          <a v-if="newLat" target="_blank" class="underline text-blue-800" :href="`https://maps.google.com/?q=(${newLat}, ${newLng})`">Google Mapsで確認</a>
          <a v-else target="_blank" class="underline text-blue-800" href="https://maps.google.com/">Google Mapsで探す</a>
        </div>
        <LocationInput
          v-model:modelValueLat="newLat"
          v-model:modelValueLng="newLng"
        />
      </div>
